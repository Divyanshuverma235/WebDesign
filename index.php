...
<?php include 'mainnavbar.php';?>
	...
	<section id="home">
		...
		<div class="btn">
			...
			<a href="course-inner.php" class="yellow">Visit Courses</a>
		</div>
	</section>
	...
	<section id="course">
		...
		<div class="course-box">
			...
			<div class="courses">
				...
				<div class="details">
					<span>Updated 21/8/22</span>
					<h6>JavaScript Intermediate Course</h6>
			...
			<div class="courses">
				...
				<div class="details">
					<span>Updated 21/8/22</span>
					<h6>JavaScript Advance Course</h6>
...
<form id="form2">
		<div class="form" id="form2">
			...
			<input type="text" placeholder="Name" name="" id="name2">
			<input type="email" placeholder="EmailID" name="" id="email2">
			<input type="text" placeholder="Contact Number" name="" id="cnum">
	...
	<section id="experts">
		...
		<div class="expert-box">
			<div class="profile">
				...
				<div class="pro-links">
					<i><a href="https://www.facebook.com/cameouttanowhere/" class="fab fa-facebook" ></a></i>
					<i><a href="https://www.instagram.com/emi.6499/"  class="fab fa-instagram"></a></i>
					<i><a href="https://www.linkedin.com/in/emma-frasheri-717bb9216/?originalSubdomain=ca"  class="fab fa-linkedin-in"></a></i>
				</div>
			</div>
			...
			<div class="profile">
				...
				<div class="pro-links">
					<i><a href="https://www.facebook.com/cameouttanowhere/" class="fab fa-facebook" ></a></i>
					<i><a href="https://www.instagram.com/_jaschua/"  class="fab fa-instagram"></a></i>
					<i><a href="https://www.linkedin.com/in/jasonchau7/"  class="fab fa-linkedin-in"></a></i>
				</div>
			</div>
			...
			<div class="profile">
				...
				<div class="pro-links">
					<i><a href="https://www.facebook.com/" class="fab fa-facebook" ></a></i>
					<i><a href="https://m.facebook.com/irfan.m.aljabar.1/"  class="fab fa-instagram"></a></i>
					<i><a href="https://www.instagram.com/"  class="fab fa-linkedin-in"></a></i>
				</div>
			</div>
			...
			<div class="profile">
				...
				<p>Design Expert</p>
				<div class="pro-links">
					<i><a href="https://www.facebook.com/jenniferlopez/" class="fab fa-facebook" ></a></i>
					<i><a href="https://www.instagram.com/jlo/?hl=en"  class="fab fa-instagram"></a></i>
					<i><a href="https://www.linkedin.com/in/thejlo/"  class="fab fa-linkedin-in"></a></i>
				</div>
			</div>
		</div>
	</section>
